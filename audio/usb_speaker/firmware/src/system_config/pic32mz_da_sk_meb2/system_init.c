...
void SYS_CLK_DYNAMIC_Initialize()
{
    ...
    PLIB_OSC_ReferenceOutputDisable ( OSC_ID_0, OSC_REFERENCE_4 );    /* Enable and configure REFCLKO5*/
    ...
    PLIB_OSC_ReferenceOscEnable ( OSC_ID_0, OSC_REFERENCE_5 );    /* Disable REFCLK5_OE*/
