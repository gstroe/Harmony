...
bool GFX_HGC_DrawItem(int itemId)
{
    switch(itemId)
    {
		...
		case Text3:
		{
			GFX_XCHAR Text3_text[] = { 0x56, 0x31, 0x2e, 0x30, 0x39, 0x0 };
		...
		case Text2:
		{
			GFX_XCHAR Text2_text[] = { 0x50, 0x49, 0x43, 0x33, 0x32, 0x4d, 0x58, 0x34, 0x37, 0x30, 0x66, 0x35, 0x31, 0x32, 0x6c, 0x20, 0x2b, 0x20, 0x42, 0x54, 0x41, 0x44, 0x4b, 0x0 };
