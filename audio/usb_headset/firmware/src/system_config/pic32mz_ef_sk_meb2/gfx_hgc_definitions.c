...
bool GFX_HGC_DrawItem(int itemId)
{
    switch(itemId)
    {
		...
		case MH_Version:
		{
			GFX_XCHAR MH_Version_text[] = { 0x56, 0x31, 0x2e, 0x30, 0x39, 0x0 };
			...
			GFX_TextStringDraw(GFX_INDEX_0,
			                   396, // draw point x
						       18, // draw point y
                               MH_Version_text, // string
							   0); // length
			break;
		}	
		case Text1:
		{
			GFX_XCHAR Text1_text[] = { 0x50, 0x49, 0x43, 0x33, 0x32, 0x4d, 0x5a, 0x32, 0x30, 0x34, 0x38, 0x45, 0x46, 0x48, 0x31, 0x34, 0x34, 0x20, 0x2b, 0x20, 0x53, 0x4b, 0x20, 0x2b, 0x20, 0x4d, 0x45, 0x42, 0x49, 0x49, 0x0 };
