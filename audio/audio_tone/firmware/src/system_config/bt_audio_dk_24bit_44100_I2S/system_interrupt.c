...
void __ISR(_CHANGE_NOTICE_VECTOR, ipl5AUTO) _IntHandlerChangeNotification(void)
{
 ...
 //REPLACE THIS: With the following button interrupt handler code.
        //GENERATED:
    ...
    {
        //APP: Read port to clear mismatch on change notice pin
        ...
        //KEEP THIS: Handle button interrupts (in buttons.c)
