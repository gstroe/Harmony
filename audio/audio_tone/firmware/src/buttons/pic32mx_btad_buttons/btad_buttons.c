...
static uint8_t      mButtonEvent = 0;   //Button Change Interrupt occurred
...
void APP_ButtonTask(void)
{
    ...
    unsigned int changed; //gives the button
    bool         intStatus;
    ...
    if (mButtonEvent == 1) 
    {
        ...
        {
            mButtonEvent = 0;
            newState = mNewButtonState; //Actual Button Change
        ...
        if (changed & APP_BUTTON1_PIN)
        {
            ...
            else if(state && (newState & APP_BUTTON1_PIN))
            {
                ...
                if (BSP_SwitchStateGet(BSP_SWITCH_1))
                {
                   ...
                   {
                       //short press actions
                       //APP_OnButtonEvent(&ag, APP_BUTTON1,false,0);
                   }
                }
            }
        } //End SW 1
...
//
// Called withing button change detection ISR
//
//******************************************************************************
