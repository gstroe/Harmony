...
#define SYS_PORT_AD1PCFG        ~0xc7df
#define SYS_PORT_CNPUE          0x0
#define SYS_PORT_CNEN           0x0

#define SYS_PORT_A_TRIS         0xc6bf
#define SYS_PORT_A_LAT          0x40
...
#define TCPIP_NETWORK_DEFAULT_HOST_NAME 			"chipKIT"
#define TCPIP_NETWORK_DEFAULT_MAC_ADDR	 			0
#define TCPIP_NETWORK_DEFAULT_IP_ADDRESS 			"192.168.1.115"
